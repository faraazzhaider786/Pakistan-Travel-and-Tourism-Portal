# Project Overview
- The AI-Powered Ministry of Tourism website is a full-stack web application developed during an internship to provide a modern digital platform for exploring Pakistan's tourism, cultural heritage, landmarks, and travel resources.
...
Frontend	React.js, JavaScript (ES6+), HTML5, CSS3, React Hooks, React Router
Backend	Node.js, Express.js, REST APIs, CORS, dotenv
Database	MongoDB, Mongoose
APIs & External Services	Browser Geolocation API, OpenStreetMap Nominatim API, Google Maps
Development Tools	Git, GitHub, Visual Studio Code, Vite, Nodemon, npm
...
git clone https://github.com/<your-username>/AI-Powered-Ministry-of-Tourism.git
